...
<p align="center">
  <b>English</b> | <a href="./README.zh-CN.md">简体中文</a> | <a href="./README.zh-TW.md">繁體中文</a> | <a href="./README.ja.md">日本語</a> | <a href="./README.ru.md">Русский</a>
</p>
...
- 🌍 **Internationalization (i18n)**:
  ...
  - Complete support for 5 languages: 🇺🇸 English (`en`), 🇨🇳 Simplified Chinese (`zh-CN`), 🇭🇰 Traditional Chinese (`zh-TW`), 🇯🇵 Japanese (`ja`), 🇷🇺 Russian (`ru`).
...
1. Visit the [Releases](../../releases) page and download `Web2MD-FeedAI-v1.2.1.zip`.
